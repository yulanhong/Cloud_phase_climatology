...
pro plot_cldmulayer25

allfname=file_search('/u/sciteam/yulanh/mydata/radar-lidar_out/radar-lidar/Serial/','*08.hdf')

For fi=0,n_elements(allfname)-1 Do Begin
fname=allfname[fi]

Tobsnum=ulonarr(72,90)
Tmulcl1_num=ulonarr(72,90,3)
