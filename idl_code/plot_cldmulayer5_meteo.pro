...
pro plot_cldmulayer5_meteo

fname="cldsat_cldclimotology5_meterology2007.hdf"
...
read_dardar,fname,'mullayercloud_onephase_pressure',mulcl1_pres
read_dardar,fname,'mullayercloud_onephase_temperature',mulcl1_temp
read_dardar,fname,'mullayercloud_onephase_uwind',mulcl1_uwind
read_dardar,fname,'mullayercloud_onephase_vwind',mulcl1_vwind
...
read_dardar,fname,'onelayercloud_surfcae_pressure',onecl_pres
read_dardar,fname,'onelayercloud_surfcae_temperature',onecl_temp
read_dardar,fname,'onelayercloud_surfcae_uwind',onecl_uwind
read_dardar,fname,'onelayercloud_surfcae_vwind',onecl_vwind
...
read_dardar,fname,'mullayercloud_mulphase_pressure',mulcln_pres
read_dardar,fname,'mullayercloud_mulphase_temperature',mulcln_temp
read_dardar,fname,'mullayercloud_mulphase_uwind',mulcln_uwind
read_dardar,fname,'mullayercloud_mulphase_vwind',mulcln_vwind
...
plot_PTwind,reform(mulcl1_pres[*,*,2,0]),reform(mulcl1_temp[*,*,2,0]),$
	reform(mulcl1_uwind[*,*,2,0]),reform(mulcl1_vwind[*,*,2,0]),lon,lat
