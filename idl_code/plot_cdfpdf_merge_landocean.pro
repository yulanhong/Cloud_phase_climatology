...
pro plot_cdfpdf_merge_landocean
...
;	print,'mixed only top',total(Tonelaytop2[*,*,1]+Tmul1laytop2[*,*,1])/total(Tonenum2[*,*,1]+Tmul1num2[*,*,1])
	...
	; === pdf ==
	  ...
	  y1=100*float(yvalue[*,0])/total(yvalue[*,0])
	  y2=100*float(yvalue[*,1])/total(yvalue[*,1])
	  y3=100*float(yvalue[*,2])/total(yvalue[*,2])
	  ind=where(xvalue ge 15)
;	  for i=0,2 do print,'ice greater than 15 km',total(yvalue[ind,i])/total(yvalue[*,i])		
	; === cdf ===	
	  pdf2cdf,yvalue,icetopcdf
	  yc1=100*float(icetopcdf[*,0])/float(icetopcdf[n_elements(y1)-1,0])
	  diff=abs(yc1-50)
	  ind=where(min(diff) eq diff)
	  if yc1[ind] le 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]+1]+(yc1[ind[0]+1]-50)*xvalue[ind])/(yc1[ind[0]+1]-yc1[ind])	  
	  if yc1[ind] gt 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]-1]+(yc1[ind[0]-1]-50)*xvalue[ind])/(yc1[ind[0]-1]-yc1[ind])	  
	  print,'ice only top median',medianv	
	  yc2=100*float(icetopcdf[*,1])/float(icetopcdf[n_elements(y1)-1,1])
	  diff=abs(yc2-50)
	  ind=where(min(diff) eq diff)
	  if yc2[ind] le 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]+1]+(yc2[ind[0]+1]-50)*xvalue[ind])/(yc2[ind[0]+1]-yc2[ind])	  
	  if yc2[ind] gt 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]-1]+(yc2[ind[0]-1]-50)*xvalue[ind])/(yc2[ind[0]-1]-yc2[ind])	  
	  print,'ice liquid top median',medianv	
	  yc3=100*float(icetopcdf[*,2])/float(icetopcdf[n_elements(y1)-1,2])
	  diff=abs(yc3-50)
	  ind=where(min(diff) eq diff)
	  if yc3[ind] le 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]+1]+(yc3[ind[0]+1]-50)*xvalue[ind])/(yc3[ind[0]+1]-yc3[ind])	  
	  if yc3[ind] gt 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]-1]+(yc3[ind[0]-1]-50)*xvalue[ind])/(yc3[ind[0]-1]-yc3[ind])	  
	  print,'ice mixed top median',medianv	
	
	  p=plot(xvalue,y1,dim=[800,700],position=pos1,name='Ice only',$
		xtitle='Ice Top (km)',ytitle=ytitle,yrange=[0,20],xrange=[0,20],axis_style=1);,errorbar_capsize=0.1)
	  ax=axis('x',target=p,location='top',showtext=0,tickdir=0)
	  ...
	  cp=plot(xvalue,yc1,/current,linestyle='dashed',position=p.position,$
		axis_style=0,yrange=[0,100]);,errorbar_capsize=0.1)
	  cp1=plot(xvalue,yc2,color='r',linestyle='dashed',overplot=cp);,errorbar_color='r',$
	  cp2=plot(xvalue,yc3,color='b',linestyle='dashed',overplot=cp);,errorbar_color='b',$
	  ax=axis('y',target=cp,location=[max(p.xrange),0,0],textpos=1,title='CDF (%)')
...
;	  for i=0,2 do print,'ice base > 10 km',total(yvalue[ind,i])/total(yvalue[*,i])		
	  pdf2cdf,yvalue,icebasecdf
	  yc1=100*float(icebasecdf[*,0])/float(icebasecdf[n_elements(y1)-1,0])
	  diff=abs(yc1-50)
	  ind=where(min(diff) eq diff)
	  if yc1[ind] le 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]+1]+(yc1[ind[0]+1]-50)*xvalue[ind])/(yc1[ind[0]+1]-yc1[ind])	  
	  if yc1[ind] gt 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]-1]+(yc1[ind[0]-1]-50)*xvalue[ind])/(yc1[ind[0]-1]-yc1[ind])	  
	  print,'ice only base median',medianv	
	  yc2=100*float(icebasecdf[*,1])/float(icebasecdf[n_elements(y1)-1,1])
	  diff=abs(yc2-50)
	  ind=where(min(diff) eq diff)
	  if yc2[ind] le 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]+1]+(yc2[ind[0]+1]-50)*xvalue[ind])/(yc2[ind[0]+1]-yc2[ind])	  
	  if yc2[ind] gt 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]-1]+(yc2[ind[0]-1]-50)*xvalue[ind])/(yc2[ind[0]-1]-yc2[ind])	  
	  print,'ice liquid base median',medianv	
	  yc3=100*float(icebasecdf[*,2])/float(icebasecdf[n_elements(y1)-1,2])
	  diff=abs(yc3-50)
	  ind=where(min(diff) eq diff)
	  if yc3[ind] le 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]+1]+(yc3[ind[0]+1]-50)*xvalue[ind])/(yc3[ind[0]+1]-yc3[ind])	  
	  if yc3[ind] gt 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]-1]+(yc3[ind[0]-1]-50)*xvalue[ind])/(yc3[ind[0]-1]-yc3[ind])	  
	  print,'ice mixed base median',medianv	
	  ...
	  cp=plot(xvalue,yc1,/current,linestyle='dashed',position=p1.position,$
		axis_style=0,yrange=[0,100]);,errorbar_capsize=0.1)
	  cp1=plot(xvalue,yc2,color='r',linestyle='dashed',overplot=cp);,errorbar_color='r',$
	  cp2=plot(xvalue,yc3,color='b',linestyle='dashed',overplot=cp);,errorbar_color='b',$
	  ax=axis('y',target=cp,location=[max(p2.xrange),0,0],textpos=1,title='CDF (%)')
...
;	  t=text(pos2[0]+0.03,pos2[3]-0.09,'79.6%',color='b',font_size=fontsz)
	...
	; === ice thick 
	  ...
	  pdf2cdf,yvalue,icethickcdf
	  yc1=100*float(icethickcdf[*,0])/float(icethickcdf[n_elements(y1)-1,0])
	  diff=abs(yc1-50)
	  ind=where(min(diff) eq diff)
	  if yc1[ind] le 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]+1]+(yc1[ind[0]+1]-50)*xvalue[ind])/(yc1[ind[0]+1]-yc1[ind])	  
	  if yc1[ind] gt 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]-1]+(yc1[ind[0]-1]-50)*xvalue[ind])/(yc1[ind[0]-1]-yc1[ind])	  
	  print,'ice only thick median',medianv	
	  yc2=100*float(icethickcdf[*,1])/float(icethickcdf[n_elements(y1)-1,1])
	  diff=abs(yc2-50)
	  ind=where(min(diff) eq diff)
	  if yc2[ind] le 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]+1]+(yc2[ind[0]+1]-50)*xvalue[ind])/(yc2[ind[0]+1]-yc2[ind])	  
	  if yc2[ind] gt 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]-1]+(yc2[ind[0]-1]-50)*xvalue[ind])/(yc2[ind[0]-1]-yc2[ind])	  
	  print,'ice liquid thick median',medianv	
	  yc3=100*float(icethickcdf[*,2])/float(icethickcdf[n_elements(y1)-1,2])
	  diff=abs(yc3-50)
	  ind=where(min(diff) eq diff)
	  if yc3[ind] le 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]+1]+(yc3[ind[0]+1]-50)*xvalue[ind])/(yc3[ind[0]+1]-yc3[ind])	  
	  if yc3[ind] gt 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]-1]+(yc3[ind[0]-1]-50)*xvalue[ind])/(yc3[ind[0]-1]-yc3[ind])	  
	  print,'ice mixed thick median',medianv	
...
;	  for i=0,2 do print,'ice thick < 3.0 km',total(yvalue[ind,i])/total(yvalue[*,i])		
	  ...
	  cp=plot(xvalue,yc1,/current,linestyle='dashed',position=p2.position,$
		axis_style=0,yrange=[0,100]);,errorbar_capsize=0.1)
	  cp1=plot(xvalue,yc2,color='r',linestyle='dashed',overplot=cp);,errorbar_color='r',$
	  cp2=plot(xvalue,yc3,color='b',linestyle='dashed',overplot=cp);,errorbar_color='b',$
	  ax=axis('y',target=cp,location=[max(p2.xrange),0,0],textpos=1,title='CDF (%)')
...
;	  t=text(pos3[0]+0.05,pos3[3]-0.09,'68.1%',color='b',font_size=fontsz)
	;=== ice tau
	  ...
	  y2=float(yvalue[*,1])/total(yvalue[*,1])
	  y3=float(yvalue[*,2])/total(yvalue[*,2])
	  pdf2cdf,yvalue,icetaucdf
	  yc1=100*float(icetaucdf[*,0])/float(icetaucdf[n_elements(y1)-1,0])
	  diff=abs(yc1-50)
	  ind=where(min(diff) eq diff)
	  if yc1[ind] le 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]+1]+(yc1[ind[0]+1]-50)*xvalue[ind])/(yc1[ind[0]+1]-yc1[ind])	  
	  if yc1[ind] gt 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]-1]+(yc1[ind[0]-1]-50)*xvalue[ind])/(yc1[ind[0]-1]-yc1[ind])	  
	  print,'ice only tau median',medianv	
	  yc2=100*float(icetaucdf[*,1])/float(icetaucdf[n_elements(y1)-1,1])
	  diff=abs(yc2-50)
	  ind=where(min(diff) eq diff)
	  if yc2[ind] le 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]+1]+(yc2[ind[0]+1]-50)*xvalue[ind])/(yc2[ind[0]+1]-yc2[ind])	  
	  if yc2[ind] gt 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]-1]+(yc2[ind[0]-1]-50)*xvalue[ind])/(yc2[ind[0]-1]-yc2[ind])	  
	  print,'ice liquid tau median',medianv	
	  yc3=100*float(icetaucdf[*,2])/float(icetaucdf[n_elements(y1)-1,2])
	  diff=abs(yc3-50)
	  ind=where(min(diff) eq diff)
	  if yc3[ind] le 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]+1]+(yc3[ind[0]+1]-50)*xvalue[ind])/(yc3[ind[0]+1]-yc3[ind])	  
	  if yc3[ind] gt 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]-1]+(yc3[ind[0]-1]-50)*xvalue[ind])/(yc3[ind[0]-1]-yc3[ind])	  
	  print,'ice mixed tau median',medianv	
	...
	;  for i=0,2 do print,'ice tau < 0.4 ',total(yvalue[ind,i])/total(yvalue[*,i])		
	 ...
	 ; for i=0,2 do print,'ice tau < 1 ',total(yvalue[ind,i])/total(yvalue[*,i])		
	  ...
	  y2=float(yvalue[*,1])/total(yvalue[*,1])
	  y3=float(yvalue[*,2])/total(yvalue[*,2])
	  pdf2cdf,yvalue,icerecdf
	  yc1=100*float(icerecdf[*,0])/float(icerecdf[n_elements(y1)-1,0])
	  diff=abs(yc1-50)
	  ind=where(min(diff) eq diff)
	  if yc1[ind] le 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]+1]+(yc1[ind[0]+1]-50)*xvalue[ind])/(yc1[ind[0]+1]-yc1[ind])	  
	  if yc1[ind] gt 50 then $
		 medianv=((50-yc1[ind])*xvalue[ind[0]-1]+(yc1[ind[0]-1]-50)*xvalue[ind])/(yc1[ind[0]-1]-yc1[ind])	  
	  print,'ice only re median',medianv	
	  yc2=100*float(icerecdf[*,1])/float(icerecdf[n_elements(y1)-1,1])
	  diff=abs(yc2-50)
	  ind=where(min(diff) eq diff)
	  if yc2[ind] le 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]+1]+(yc2[ind[0]+1]-50)*xvalue[ind])/(yc2[ind[0]+1]-yc2[ind])	  
	  if yc2[ind] gt 50 then $
		 medianv=((50-yc2[ind])*xvalue[ind[0]-1]+(yc2[ind[0]-1]-50)*xvalue[ind])/(yc2[ind[0]-1]-yc2[ind])	  
	  print,'ice liquid re median',medianv	
	  yc3=100*float(icerecdf[*,2])/float(icerecdf[n_elements(y1)-1,2])
	  diff=abs(yc3-50)
	  ind=where(min(diff) eq diff)
	  if yc3[ind] le 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]+1]+(yc3[ind[0]+1]-50)*xvalue[ind])/(yc3[ind[0]+1]-yc3[ind])	  
	  if yc3[ind] gt 50 then $
		 medianv=((50-yc3[ind])*xvalue[ind[0]-1]+(yc3[ind[0]-1]-50)*xvalue[ind])/(yc3[ind[0]-1]-yc3[ind])	  
	  print,'ice mixed re median',medianv	
	...
	;=== mixed top
	  ...
	  p.save,'top_base_thick_cdfpdfsls_allyear_day_newdomain.png' 
