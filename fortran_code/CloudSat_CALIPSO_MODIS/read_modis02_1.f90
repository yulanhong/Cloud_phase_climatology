		...
		use global, only: modNrow,modNcol,rad_250,rad_500,rad_1000,&
			rad_1000emis
	
        implicit none

        !-----------------------------------------
        character(len=250) :: fname,sds_name
		real, allocatable :: offset(:),vscale(:)
		integer (kind=2), allocatable :: rad_250_1(:,:,:),rad_500_1(:,:,:),&
 	       rad_1000_1(:,:,:),rad_1000emis_1(:,:,:) 
